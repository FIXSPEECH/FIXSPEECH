...
public interface TrainingApi {
	...
	com.fixspeech.spring_server.global.common.ApiResponse<?> start(Long trainingId);
	...
	com.fixspeech.spring_server.global.common.ApiResponse<?> answer(TrainingRequestDto trainingRequestDto);
}