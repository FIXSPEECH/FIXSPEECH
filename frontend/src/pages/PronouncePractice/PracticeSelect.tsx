...
// 아이콘 img import
import puzzle from '../../assets/buttons/puzzle.png'
...
function PracticeSelect(){
    ...
    const gridItems = [
        { color: '#FF8C82', label: '문장연습', imageSrc: music, url:'/pronounce/practice', imgMargin: 50 },
        { color: '#FF8C82', label: '잰말놀이', imageSrc: puzzle, url:'/pronounce/tongue/twister', imgMargin: 50 },
      ];
